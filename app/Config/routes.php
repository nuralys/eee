...
Router::connect('/news/local/*', array('controller' => 'news', 'action' => 'local'));
Router::connect('/news/world/*', array('controller' => 'news', 'action' => 'world'));
 ...
 */
	...
	Router::connect('/service/*', array('controller' => 'services'));
